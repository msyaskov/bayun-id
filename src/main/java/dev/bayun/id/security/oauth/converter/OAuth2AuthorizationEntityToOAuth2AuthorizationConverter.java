...
public class OAuth2AuthorizationEntityToOAuth2AuthorizationConverter implements Converter<OAuth2AuthorizationEntity, OAuth2Authorization> {
    ...
    @Override
    public OAuth2Authorization convert(OAuth2AuthorizationEntity entity) {
