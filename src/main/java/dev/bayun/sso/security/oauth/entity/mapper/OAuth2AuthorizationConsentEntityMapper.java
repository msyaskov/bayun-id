...
@Component
public class OAuth2AuthorizationConsentEntityMapper implements EntityMapper<OAuth2AuthorizationConsentEntity, OAuth2AuthorizationConsent> {

    private final RegisteredClientRepository registeredClientRepository;

    public OAuth2AuthorizationConsentEntityMapper(RegisteredClientRepository registeredClientRepository) {
        Assert.notNull(registeredClientRepository, "a registeredClientRepository must not be null");
        this.registeredClientRepository = registeredClientRepository;
    }

    @Override
    public OAuth2AuthorizationConsentEntity toEntity(OAuth2AuthorizationConsent authorizationConsent) {
    ...
    @Override
    public OAuth2AuthorizationConsent toObject(OAuth2AuthorizationConsentEntity entity) {
