...
@Component
public class RegisteredClientEntityMapper implements EntityMapper<RegisteredClientEntity, RegisteredClient> {

    @Qualifier("oAuth2ObjectMapper")
    private final ObjectMapper objectMapper;

    public RegisteredClientEntityMapper(ObjectMapper objectMapper) {
    ...
    @Override
    public RegisteredClient toObject(RegisteredClientEntity entity) {
