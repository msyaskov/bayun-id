...
@Component
public class OAuth2AuthorizationEntityConverter implements EntityConverter<OAuth2AuthorizationEntity, OAuth2Authorization> {
    ...
    @Override
    public OAuth2AuthorizationEntity convertToEntity(OAuth2Authorization authorization) {
    ...
    @Override
    public OAuth2Authorization convertToObject(OAuth2AuthorizationEntity entity) {
